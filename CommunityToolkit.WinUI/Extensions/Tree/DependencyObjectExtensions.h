...
namespace winrt::CommunityToolkit::WinUI
{
	...
	T FindDescendant(DependencyObject const& element, TPredicate& predicate)
	...
	T FindDescendant(DependencyObject const& element, TState&& state, const std::function<bool(T, TState&&)>& predicate)
		requires winrt::derived_from<T, DependencyObject>
	{
	...
	template <typename T>
	T FindDescendant(DependencyObject const& element, std::function<bool(T)>& predicate)
		requires winrt::derived_from<T, DependencyObject>
	{
		return FindDescendant(element, predicate);
	}

	DependencyObject FindDescendant(DependencyObject const& element, winrt::Windows::UI::Xaml::Interop::TypeName type)
	{
	...
	template <typename T>
	T FindDescendant(DependencyObject const& element)
		requires winrt::derived_from<T, DependencyObject>
	{
	...
	FrameworkElement FindDescendant(DependencyObject const& element, std::wstring_view name)
	{
	...
	FrameworkElement FindDescendantOrSelf(DependencyObject const& element, std::wstring_view name)
	{
	...
	template <typename T>
	T FindDescendantOrSelf(DependencyObject const& element)
		requires winrt::derived_from<T, DependencyObject>
	{
	...
	DependencyObject FindDescendantOrSelf(DependencyObject const& element, winrt::Windows::UI::Xaml::Interop::TypeName type)
	{
	...
	template <typename T>
	T FindDescendantOrSelf(DependencyObject const& element, const std::function<bool(T)>& predicate)
		requires winrt::derived_from<T, DependencyObject>
	{
	...
	template <typename T, typename TState>
	T FindDescendantOrSelf(DependencyObject const& element, TState&& state, const std::function<bool(T, TState&&)>& predicate)
		requires winrt::derived_from<T, DependencyObject>
	{
	...
	void FindDescendants(DependencyObject const& element, std::vector<DependencyObject>& result)
	{
		int childrenCount = VisualTreeHelper::GetChildrenCount(element);
	...
	template<typename T, IPredicate<T> TPredicate>
	T FindAscendant(DependencyObject element, TPredicate& predicate)
		requires winrt::derived_from<T, DependencyObject>
	{
		while (true)
		{
	...
	template<typename T, typename TState>
	T FindAscendant(DependencyObject const& element, TState&& state, const std::function<bool(T, TState&&)>& predicate)
		requires winrt::derived_from<T, DependencyObject>
	{
		PredicateByFunc<T, TState> predicateByFunc(state, predicate);
	...
	DependencyObject FindAscendant(DependencyObject const& element, winrt::Windows::UI::Xaml::Interop::TypeName type)
	{
		PredicateByType predicateByType(type);
	...
	template <typename T>
	T FindAscendant(DependencyObject const& element)
		requires winrt::derived_from<T, DependencyObject>
	{
		PredicateByAny<T> predicateByAny;
	...
	FrameworkElement FindAscendant(DependencyObject const& element, std::wstring_view name)
	{
		PredicateByName predicateByName(name);
	...
	FrameworkElement FindAscendantOrSelf(DependencyObject const& element, std::wstring_view name)
	{
	...
	template<typename T>
	T FindAscendantOrSelf(DependencyObject const& element)
		requires winrt::derived_from<T, DependencyObject>
	{
		if (auto result = element.try_as<T>(); result)
		{
	...
	DependencyObject FindAscendantOrSelf(DependencyObject const& element, winrt::Windows::UI::Xaml::Interop::TypeName type)
	{
		if (winrt::get_class_name(element) == type.Name)
		{
			return element;
	...
	template<typename T>
	T FindAscendantOrSelf(DependencyObject const& element, const std::function<bool(T)>& predicate)
		requires winrt::derived_from<T, DependencyObject>
	{
		if (auto result = element.try_as<T>(); result && predicate(result))
		{
	...
	template<typename T, typename TState>
	T FindAscendantOrSelf(DependencyObject const& element, TState state, const std::function<bool(T, TState)>& predicate)
		requires winrt::derived_from<T, DependencyObject>
	{
		if (auto result = element.try_as<T>(); result && predicate(result, state))
		{
	...
	std::generator<DependencyObject> FindAscendants(DependencyObject element)
	{
