...
#include "StartAnimationAction.g.h"
...
{
    /// <summary>
    /// An IAction implementation that can trigger a target AnimationSet instance.
    /// </summary>
...
{
    struct StartAnimationAction : StartAnimationActionT<StartAnimationAction, implementation::StartAnimationAction>
    {
    };
}
