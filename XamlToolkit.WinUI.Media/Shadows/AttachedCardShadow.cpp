...
namespace winrt::XamlToolkit::WinUI::Media::implementation
{
    ...
    CompositionBrush AttachedCardShadow::GetShadowMask(XamlToolkit::WinUI::AttachedShadowElementContext const& context)
    {
    ...
    CompositionClip AttachedCardShadow::GetShadowClip(XamlToolkit::WinUI::AttachedShadowElementContext const& context) const
    {
