...
#include "Animations.ExposureEffectAnimation.g.h"
#include "EffectAnimationBase.h"
#include "../Effects/ExposureEffect.h"
...
{
    struct ExposureEffectAnimationTraits
    {
		using effect_type = ExposureEffect;
        using class_type = winrt::XamlToolkit::WinUI::Media::Animations::ExposureEffectAnimation;
    ...
    struct ExposureEffectAnimation : ExposureEffectAnimationT<ExposureEffectAnimation, ITimeline>, EffectAnimationBase<ExposureEffectAnimationTraits>
    {
        ExposureEffectAnimation() = default;
        ...
        {
            return EffectAnimationBase<ExposureEffectAnimationTraits>::AppendToBuilder(builder, delay, duration, easingType, easingMode);
        }

        winrt::hstring ExplicitTarget() const override
        {
			auto targetImpl = winrt::get_self<winrt::XamlToolkit::WinUI::Media::implementation::ExposureEffect>(Target());
