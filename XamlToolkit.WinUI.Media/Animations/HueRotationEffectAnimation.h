...
#include "Animations.HueRotationEffectAnimation.g.h"
...
{
    struct HueRotationEffectAnimationTraits
    {
		using effect_type = HueRotationEffect;
        using class_type = winrt::XamlToolkit::WinUI::Media::Animations::HueRotationEffectAnimation;
    ...
    struct HueRotationEffectAnimation : HueRotationEffectAnimationT<HueRotationEffectAnimation, ITimeline>, EffectAnimationBase<HueRotationEffectAnimationTraits>
    {
        HueRotationEffectAnimation() = default;
        ...
        {
            return EffectAnimationBase<HueRotationEffectAnimationTraits>::AppendToBuilder(builder, delay, duration, easingType, easingMode);
        }

        winrt::hstring ExplicitTarget() const override
        {
			auto targetImpl = winrt::get_self<winrt::XamlToolkit::WinUI::Media::implementation::HueRotationEffect>(Target());
