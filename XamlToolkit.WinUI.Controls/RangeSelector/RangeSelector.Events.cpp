...
{
    winrt::event_token RangeSelector::ThumbDragStarted(winrt::DragStartedEventHandler const& handler)
    {
    ...
    winrt::event_token RangeSelector::ThumbDragCompleted(winrt::DragCompletedEventHandler const& handler)
    {
    ...
    void RangeSelector::OnThumbDragStarted(winrt::DragStartedEventArgs const& e)
    {
        if (_thumbDragStarted) _thumbDragStarted(*this, e);
    }

    void RangeSelector::OnThumbDragCompleted(winrt::DragCompletedEventArgs const& e)
    {
