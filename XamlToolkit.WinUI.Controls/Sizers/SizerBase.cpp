...
namespace winrt::XamlToolkit::WinUI::Controls::implementation
{
	...
	void SizerBase::OnApplyTemplate()
	{
		...
		_pointerCanceledRevoker = PointerCanceled(winrt::auto_revoke, { this, &SizerBase::SizerBase_PointerCanceled });
		_pointerCaptureLostRevoker = PointerCaptureLost(winrt::auto_revoke, { this, &SizerBase::SizerBase_PointerCaptureLost });
