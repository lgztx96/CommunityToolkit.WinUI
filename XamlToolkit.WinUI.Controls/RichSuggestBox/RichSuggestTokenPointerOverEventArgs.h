...
namespace winrt::XamlToolkit::WinUI::Controls::implementation
{
	struct RichSuggestTokenPointerOverEventArgs : RichSuggestTokenPointerOverEventArgsT<RichSuggestTokenPointerOverEventArgs>
	{
		...
		RichSuggestTokenPointerOverEventArgs(
			...
			winrt::Microsoft::UI::Text::ITextRange const& range,
			winrt::Microsoft::UI::Input::PointerPoint const& point)
		...
		wil::single_threaded_rw_property<winrt::Microsoft::UI::Text::ITextRange> Range{ nullptr };

		wil::single_threaded_rw_property<winrt::Microsoft::UI::Input::PointerPoint> CurrentPoint{ nullptr };
	};
}
