...
namespace winrt::XamlToolkit::WinUI::Animations::implementation
{
    ...
    struct ColorDropShadowAnimation : ColorDropShadowAnimationT<ColorDropShadowAnimation, ShadowAnimationBase<ColorDropShadowAnimationTraits>, IAttachedTimeline>
    {
