...
namespace winrt::XamlToolkit::Labs::WinUI::implementation
{
	struct TokenItemRemovingEventArgs : TokenItemRemovingEventArgsT<TokenItemRemovingEventArgs>
	{
		...
		TokenItemRemovingEventArgs(
			...
			winrt::XamlToolkit::Labs::WinUI::TokenItem const& tokenItem)
			: Item(item), TokenItem(tokenItem) {};

		wil::single_threaded_property<winrt::Windows::Foundation::IInspectable> Item{ nullptr };
