...
namespace winrt::XamlToolkit::Labs::WinUI::implementation
{
    ...
    void DataColumn::OnApplyTemplate()
    {
        if (_columnSizer)
        {
            ...
            _columnSizer.ManipulationStarted(_columnSizerManipulationStartedToken);
        ...
        if (_columnSizer)
        {
            ...
            _columnSizer.TargetControl(nullptr);
            _columnSizerManipulationStartedToken = _columnSizer.ManipulationStarted({ this, &DataColumn::ColumnSizer_ManipulationStarted });
