...
namespace winrt::XamlToolkit::WinUI::implementation
{
	...
	void AttachedDropShadow::OnElementContextUninitialized(winrt::XamlToolkit::WinUI::AttachedShadowElementContext const& context)
	{
	...
	void AttachedDropShadow::SetElementChildVisual(winrt::XamlToolkit::WinUI::AttachedShadowElementContext const& context)
	{
